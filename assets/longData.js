...
// const pdfs = Object.keys(allPdfsToPath);
// const checkBoxesLst = Object.keys(checkBoxes);

// for (let i = 0; i < checkBoxesLst.length; i++) {
//   const theUri = allPdfsToPath[checkBoxesLst[i].split(' ').join('')].uri;
//   // console.log(theUri, checkBoxes[checkBoxesLst[i]]);
//   checkBoxes[checkBoxesLst[i]]['uri'] = theUri;
// }
